...
public class AsciiFont {
    ...
    public static final AsciiFont gold = new AsciiFont("Gold_plated_24x24.png", 24, 24);
    public static final AsciiFont Bisasam = new AsciiFont("Bisasam_24x24.png", 24, 24);
